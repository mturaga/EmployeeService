            ...
            policyRegistry.Add(
                ...
                HttpPolicyExtensions
                    ...
                    .WaitAndRetryAsync(
                        ...
                        retryAttempt => TimeSpan.FromSeconds(Math.Pow(policyOptions.HttpRetry.BackoffPower, retryAttempt)), (response, delay, retryCount, context) =>
                        {
                            Log.Error(response.Result.Content.ToString());
